...
ALTER TABLE `barang_masuk` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE `barang_masuk` AUTO_INCREMENT=1;

ALTER TABLE `detail_transaksi` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE `detail_transaksi` AUTO_INCREMENT=1;

ALTER TABLE `kategori` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE `kategori` AUTO_INCREMENT=10;

ALTER TABLE `kredit` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE `kredit` AUTO_INCREMENT=1;

ALTER TABLE `pelanggan` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE `pelanggan` AUTO_INCREMENT=1;

ALTER TABLE `produk` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE `produk` AUTO_INCREMENT=164;

ALTER TABLE `promo` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE `promo` AUTO_INCREMENT=5;

ALTER TABLE `supplier` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE `supplier` AUTO_INCREMENT=6;

ALTER TABLE `transaksi` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
