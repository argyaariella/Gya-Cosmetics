    ...
    <div class="row align-items-center g-4">
      ...
      <div class="col-lg-6 d-none d-lg-block">
        <div style="position:relative;height:360px;">
          ...
          <div class="float-card" style="position:absolute;bottom:30px;right:0;width:170px;animation:f2 5.5s ease-in-out infinite;">
          ...
          <div style="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);background:linear-gradient(135deg,var(--rose),var(--rose-deep));border-radius:20px;padding:20px;width:155px;box-shadow:0 10px 36px rgba(244,63,136,.38);animation:f3 7s ease-in-out infinite;text-align:center;">
          ...
          <div class="float-card" style="position:absolute;bottom:0;left:0;width:160px;animation:f1 6s ease-in-out infinite 1s;">
    ...
    <div class="col">
      <div class="produk-card">
        ...
        <div class="produk-body">
          ...
          <?php if($stok_ok): ?>
          <a href="https://wa.me/<?=WA_NUMBER?>?text=<?=$wa_msg?>" target="_blank" class="btn-wa">
